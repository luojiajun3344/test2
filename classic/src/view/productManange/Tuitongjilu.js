Ext.define('Admin.view.productManage.Tuitongjilu', {
    extend: 'Admin.view.BasePage',
    border: false,
    alias : 'widget.tuitongjilu',
    height:600,
	title :'退砼记录管理',
    requires: [
        // 'Admin.view.productManage.RoleWindow'
       
    ],
	// controller: 'jiashiyuan',
    initComponent: function() {
    	var roleStore =null;// Ext.create('Admin.store.productManage.Roles');
