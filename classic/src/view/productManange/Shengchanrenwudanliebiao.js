...
Ext.define('Admin.view.productManage.Shengchanrenwudanliebiao',{
    	  			...
    	  			region : 'center',
    	 	  		...
    	 	  		dockedItems :[{
		            	       ...
		            	       items: [
		            	               ...
		            	               {text:'增加零星单',tooltip:'添加一个部门',iconCls:'x-fa fa-plus',itemId:'add2',hidden : !Admin.app.checkRight(127, 1)},
		            	               {text:'审核',tooltip:'修改选中部门',disabled:true,iconCls:'x-fa fa-edit',itemId:'update2',hidden : !Admin.app.checkRight(127, 2)},
		            	               {text:'反审核',tooltip:'删除选中部门',disabled:true,iconCls:'x-fa fa-minus',itemId:'del2',hidden : !Admin.app.checkRight(127, 3)},
									   {text:'启用',tooltip:'添加一个部门',iconCls:'x-fa fa-plus',itemId:'add3',hidden : !Admin.app.checkRight(127, 1)},
		            	               {text:'禁用',tooltip:'修改选中部门',disabled:true,iconCls:'x-fa fa-edit',itemId:'update3',hidden : !Admin.app.checkRight(127, 2)},
		            	               {text:'完工',tooltip:'删除选中部门',disabled:true,iconCls:'x-fa fa-minus',itemId:'del3',hidden : !Admin.app.checkRight(127, 3)},
									   {text:'生产调度',tooltip:'添加一个部门',iconCls:'x-fa fa-plus',itemId:'add4',hidden : !Admin.app.checkRight(127, 1)}
