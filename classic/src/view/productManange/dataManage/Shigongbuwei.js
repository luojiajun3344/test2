...
Ext.define('Admin.view.productManage.dataManage.Shigongbuwei',{
	 extend: 'Admin.view.BasePage',
	 xtype: 'shigongbuwei',
	// alias : 'widget.shigongbuwei',
	 title : '施工部位',
     //border : false,
     closable: true,
     layout:'border',
    ...
    margin: '20 0 0 20',
     ...
     var logMgrStore = null;//Ext.create('Admin.store.productManage.dataManage.BangcheStore');
    	 this.items=[{
    		xtype : 'searchForm',
 			region : 'north',
 			frame : true,
