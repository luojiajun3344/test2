 ...
 * LJY 2012.12.01
 */
Ext.define('Admin.view.GroupTreeCombobox', {
    extend:'Ext.form.field.ComboBox',
    alias: ['widget.grouptreecombobox', 'widget.grouptreecombo'],
    //alternateClassName: 'Ext.form.Hidden',

    // private
    inputType : 'grouptreecombo',
    //hideLabel: true,
    url: '',
    treePanel : {},
    tree: {},
    ...
    initComponent: function () {
      ...
      //  this.displayField = this.displayField || 'text',
        ...
        this.tree.on('itemclick', function (view, record) {
			...
			if (record)
				record.data.newtext = Admin.app.getGroupName(me.groupId) ; //得到包含父分组的完整路径名
            me.collapse();
        });
	    ...
	    window.setTimeout(function(){
	        ...
	        for (i = 0, len = value.length; i < len; i++) {
	            ...
	            if (!record || !record.isModel) {
					...
					if (record)
						record.data.newtext = Admin.app.getGroupName(me.groupId) ; //得到包含父分组的完整路径名
					//me.tree.getSelectionModel().setLastFocused(record);
					//-----
