Ext.define('Admin.view.baseinfo.Jiashiyuan', {
    extend: 'Admin.view.BasePage',
    border: false,
    alias : 'widget.jiashiyuan',
    height:600,
	title :'驾驶员管理',
    requires: [
        // 'Admin.view.baseinfo.RoleWindow'
       
    ],
	// controller: 'jiashiyuan',
    initComponent: function() {
    	var roleStore =null;// Ext.create('Admin.store.baseinfo.Roles');
