Ext.define('Admin.view.systemadmin.RolePanel', {
    extend: 'Admin.view.BasePage',
    border: false,
    alias : 'widget.systemadminRolePanel',
    height:600,
	
    requires: [
        'Admin.view.systemadmin.RoleWindow'
       
    ],
	controller: 'systemadminRolePanel',
    initComponent: function() {
    	var roleStore = Ext.create('Admin.store.systemadmin.Roles');
		roleStore.add({roleId:1,roleName:'df'});
    	this.items = [
    	    {
