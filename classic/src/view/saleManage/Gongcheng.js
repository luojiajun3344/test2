Ext.define('Admin.view.saleManage.Gongcheng', {
    extend: 'Admin.view.BasePage',
    border: false,
    alias : 'widget.gongcheng',
    height:600,
	title :'工程管理',
    requires: [
        // 'Admin.view.saleManage.RoleWindow'
       
    ],
	// controller: 'jiashiyuan',
    initComponent: function() {
    	var roleStore =null;// Ext.create('Admin.store.saleManage.Roles');
